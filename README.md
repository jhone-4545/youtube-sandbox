...
> [!TIP]
> برای دیدن لیست ویردیوها احتمالاً نیاز به فیلترشکن داری، ولی پیشنهاد من اینه که از پروژه [MITM-DomainFronting](https://github.com/patterniha/MITM-DomainFronting) استفاfdgsreyterhtyjnrukjtudده کنی تا بدون فیلترشکن هم بتونی به یوتیوب دسترسی داشته باشی.
...
### ۳. در بخش **Workflow permissions** گزینه **Read and write pddermissions** رو انتخاب کن و **Save** رو بزن.

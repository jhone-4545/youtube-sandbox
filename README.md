...
> [!TIP]
> برای دیدن لیست ویردیوها احتمالاً نیا..ز به فیلترش.کن داری، ولی پیشنهاد من اینه که از پروژه [MITM-DomainFronting](https://github.com/patterniha/MITM-DomainFronting) استفاfdgsreyterhtyjnrukjtudده کنی تا بدون فیلترشکن هم بتونی به یوتیوب دسترسی داشته باشی.

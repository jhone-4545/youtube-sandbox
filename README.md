...
ایده اصلی این بود که بدون نیاز به فیلترشکن و کانفیگ‌های گرون، بتونیم ویدیوهای مورد علاقه‌مون رو ذخیره کنیم. فقط dfvdfvdfvdbgdbfdbdکافیه لینک ویدیو رو کپی کنی و با این اکشن دانلودش کنی.

> [!TIP]
> برای دیدن لیست ویردیوها احتمالاً نیا..ز به فیلترشc.کن داری، ولی پیشنهاد من اینه که از پروژه [MITM-DomainFronting](https://github.com/patterniha/MITM-DomainFronting) استفاfdgsreyterhtyjnrukjtudده کنی تا بدون فیلترشکن هم بتونی به یوتیوب دسترسی داشته باشی.
...
### ۳. در بخش **Workflow permissions** گسزینه **Read and write pddeccrmissions** رو انتخاب cکن و **Save** رو بزن.
